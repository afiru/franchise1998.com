            ...
            <li class="liNavTopOnline">
                <a class="d_block btnNavTopOnline" href="https://selvice-lifedesign.jp/" target="_blank">
                    <picture>
                        ...
                        <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/index/btnNavTopOnline01Pc.png'); ?>" alt="<?php echo esc_attr('説明テキスト'); ?>" width="627" height="136">
                    </picture>
                </a>
            </li>
            ...
            <li class="liNavTopOnline">
                <a class="d_block btnNavTopOnline" href="https://selvice-members.co.jp/" target="_blank">
                    <picture>
                        ...
                        <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/index/btnNavTopOnline02Pc.png'); ?>" alt="<?php echo esc_attr('説明テキスト'); ?>" width="627" height="136">
                    </picture>
                </a>
            </li>
        </ul>
