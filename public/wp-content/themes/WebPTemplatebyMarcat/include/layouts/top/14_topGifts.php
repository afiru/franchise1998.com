...
<div class="topGifts">
    <div class="wapper topGiftsWap">
        ...
        <ul class="d_flex j_between row ulTopGifts">
            ...
            <?php $i++; ?>
            <li class="liTopGifts">
                <a class="d_flex j_between undernone btnLiTopGifts" href="<?php echo get_permalink($post->ID); ?>">
        ...
        <div class="btnCntTopGiftsLxn">
            <a class="d_flex j_center ali_center cl_F04E11 undernone fw_500 kaku btnCntTopGifts" href="<?php echo home_url('/suggestion/'); ?>">
