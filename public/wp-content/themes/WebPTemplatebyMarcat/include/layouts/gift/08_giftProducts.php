    ...
    <div class="wapper giftProductsWap">
        <section class="secGiftProducts">
            ...
            <div class="btnCntGiftProductsLxn">
                <a class="d_flex j_center ali_center cl_F04E11 undernone fw_500 kaku btnCntGiftProducts" href="<?php echo home_url('/products/product-category/baked-goods-and-gifts/'); ?>">
