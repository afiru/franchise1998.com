<section class="secCntProductPost">
    ...
    <?php if (scf::get('flugAllergy') === '表示'): ?>
        <div class="bg_F1ECE8 listInfoProductsPosts">
            <div class="listInfoProductsPostsLxn">
                <?php if (in_array("なし", scf::get('chackListAllergyProductsPost')) or empty(scf::get('chackListAllergyProductsPost'))): ?>
                <?php else: ?>
                    <section class="secListInfoProductsPosts">
                        <h2 class="d_flex j_start ali_end cl_453C3C fw_500 kaku txtset h2ListInfoProductsPosts">
                            ...
                            <span class="littleH2ListInfoProductsPosts">特定原材料（9品目）</span>
                        </h2>
                ...
                <?php if (in_array("なし", scf::get('genzairyoProductsPosts')) or empty(scf::get('genzairyoProductsPosts'))): ?>
                ...
                <?php else: ?>
                    <section class="secListInfoProductsPosts secListInfoProductsPosts02">
                        <h2 class="d_flex j_start ali_end cl_453C3C fw_500 txtset kaku h2ListInfoProductsPosts">
                            <span class="BigH2ListInfoProductsPosts">特定原材料に準ずるもの</span>
                        </h2>
    ...
    <!--商品：デコレーションアレルギーについて--->
    <?php $flugcake = scf::get('flugDecorationAllergy'); ?>
    <?php if ($flugcake === '表示'): ?>
        <section class="bg_FFF2ED postDecorationAllergy">
            <h2 class="t_center cl_45413C fw_400 txtset h2PostDecorationAllergy">デコレーションケーキの<br class="sp_only">アレルギー対応について</h2>
            <p class="cl_45413C fw_400 text_justify txtPostDecorationAllergy">
                当店では、店頭またはお電話でご相談いただいた場合に限り、可能な範囲でアレルギー対応を承っております。なお、すべての商品を同一の工房・設備で製造しているため、完全な除去は保証できません。また、レシピに関わる変更はいたしておりません。
            </p>
        </section>
    <?php endif; ?>
    <!--商品：デコレーションアレルギーについて--->
