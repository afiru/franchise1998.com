<div class="memberBnr">
    <div class="wapper memberBnrWap">
        <section class="secMemberBnr">
            <h2 class="t_center cl_453C3C fw_500 h2MemberBnr">さらに!セルビスゴールドカードをお持ちなら</h2>
            ...
            <a class="d_block btnMemberBnr" href="https://selvice-members.co.jp/" target="_blank">
                <picture>
                    ...
                    <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/member/btnMemberBnrPc.png'); ?>" alt="<?php echo esc_attr('10%オフ'); ?>" width="1200" height="340">
                </picture>
            </a>
        </section>
