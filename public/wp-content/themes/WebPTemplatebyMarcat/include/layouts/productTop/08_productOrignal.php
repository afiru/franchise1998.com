...
<?php if ($query1->have_posts()): ?>
    <div class="prductLoopDefo pore prductLoopUnder">
        ...
        <section class="secPrductLoopDefo secPrductLoopUnder">
            <h2 class="cl_F28962 fw_500 txtset CormorantUnicase h2PrductLoopDefo">ORIGINAL PRINT SWEETS</h2>
            <p class="cl_453C3C fw_500 txtset rubyPrductLoopDefo">オリジナルプリントスイーツ</p>
