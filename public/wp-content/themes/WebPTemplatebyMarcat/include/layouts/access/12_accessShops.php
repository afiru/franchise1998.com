            ...
            <?php foreach (scf::get('loopAccessLocation') as $fields): ?>
                <li class="liAccessShops">
                    ...
                    <div class="btnAccessShopsLxn">
                        <a class="d_flex j_center ali_center kaku txtset t_center undernone cl_F04E11 fw_500 btnAccessShops" href="<?php echo $fields['urlAccessLocation']; ?>" target="_blank">
