<div class="underFv aboutUnderFv">
    ...
    <div class="pore aboutUnderFvLxn">
        ...
        <figure class="picAboutUnderFv">
            <picture>
                <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/access/picaccessUnderFvPc.png'); ?>">
                <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/access/picaccessUnderFvSp.png'); ?>">
                <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/access/picaccessUnderFvPc.png'); ?>" alt="<?php echo esc_attr('access背景'); ?>" width="1698" height="696">
            </picture>
        </figure>
    </div>
</div>
