<div class="tamaranOnline">
    <div class="wapper tamaranOnlineWap">
        <div class="bg_FFFBF0 tamaranOnlineLxn">
            <div class="d_flex j_between row tamaranOnlineFx">
                <figure class="phoTotamaranOnline">
                    <picture>
                        <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/tamaran/phoTotamaranOnlinePc.png'); ?>">
                        <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/tamaran/phoTotamaranOnlineSp.png'); ?>">
                        <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/tamaran/phoTotamaranOnlinePc.png'); ?>" alt="<?php echo esc_attr('オンラインでも購入できます。'); ?>" width="457.064" height="329.325">
                    </picture>
                </figure>

                <section class="secTotamaranOnline">
                    <h2 class="h2TotamaranOnline">
                        <picture>
                            <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/tamaran/h2TotamaranOnlinePc.svg'); ?>">
                            <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/tamaran/h2TotamaranOnlineSp.svg'); ?>">
