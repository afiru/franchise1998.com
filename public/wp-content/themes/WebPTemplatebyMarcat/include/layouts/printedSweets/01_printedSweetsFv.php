<div class="underFv aboutUnderFv">
    ...
    <div class="pore aboutUnderFvLxn">
        ...
        <figure class="picAboutUnderFv">
            <picture>
                <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/printedSweets/picPrintedSweetsUnderFvPc.png'); ?>">
                <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/printedSweets/picPrintedSweetsUnderFvSp.png'); ?>">
                <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/printedSweets/picPrintedSweetsUnderFvPc.png'); ?>" alt="<?php echo esc_attr('素材へのこだわり'); ?>" width="1698" height="696">
            </picture>
        </figure>
    </div>
</div>
