<div class="underFv aboutUnderFv">
    <div class="wapper aboutUnderFvWap">
        <section class="secAboutUnderFv">
            <h1 class="cl_421D12 fw_500 CormorantUnicase txtset h1AboutUnderFv">COMMITMENT</h1>
            <p class="cl_453C3C fw_500 txtset txtAboutUnderFv">素材へのこだわり</p>
        </section>
    </div>
    ...
    <div class="pore aboutUnderFvLxn">
        ...
        <figure class="picAboutUnderFv">
            <picture>
                <source media="(min-width: 768px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/partyplan/picPartyplanUnderFvPc.png'); ?>">
                <source media="(max-width: 767px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/img/partyplan/picPartyplanUnderFvSp.png'); ?>">
                <img loading="lazy" src="<?php echo esc_url(get_template_directory_uri() . '/img/partyplan/picPartyplanUnderFvPc.png'); ?>" alt="<?php echo esc_attr('素材へのこだわり'); ?>" width="1698" height="696">
            </picture>
        </figure>
    </div>
</div>
