<div id="" class="bg_F1ECE8 partyPlanDrinkMenu">
    <div id="drink" class="wapper pore partyPlanDrinkMenuWap">
        ...
        <ul class="d_flex j_start ulPartyPlanDrinkMenu">
            <?php foreach (scf::get('loopNonAlcoholDrinkMenu') as $fields): ?>
                <li class="liPartyPlanDrinkMenu">
                    <div class="d_flex j_between row liPartyPlanDrinkMenuFx">
                        <?php $img = get_scf_img_loop_url_id($fields['imgsNonAlcoholDrinkMenu']); ?>
                        <?php if (!empty($img[0])): ?>
                            <figure class="photoPartyPlanDrinkMenu">
                                <img loading="lazy" src="<?php echo $img[0]; ?>" alt="<?php echo $fields['titleNonAlcoholDrinkMenu']; ?>写真" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>">
                            </figure>
                        <?php endif; ?>
                        <section class="secPartyPlanDrinkMenuFx secPartyPlanDrinkMenuFxNon">
                            <h4 class="cl_772D2D fw_500 txtset h4PartyPlanDrinkMenu"><?php echo $fields['titleNonAlcoholDrinkMenu']; ?></h4>
                            <p class="cl_772D2D fw_600 txtset pricePartyPlanDrinkMenu"><?php echo $fields['priceNonAlcoholDrinkMenu']; ?></p>
                        </section>
                    </div>
                    <p class="cl_453C3C fw_400 txtset text_justify txtPartyPlanDrinkMenu">
                        <?php echo nl2br($fields['txtNonAlcoholdrinkmenu']); ?>
                    </p>
                </li>
            <?php endforeach; ?>
        </ul>
