...
* Fixed: WPML compatibility issue where flush_rewrite_rules returned different category counts per language, causing 404 errors
* Improved: Enhanced get_categories filtering for better multilingual support
